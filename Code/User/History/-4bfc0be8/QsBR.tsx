...
export const GreatingSection = () => {
	return (
		<>
			<div className="max-w-5xl max-md:max-w-xl sm:px-6 mx-auto my-48">
				<div className="text-center max-w-2xl mx-auto">
					<h2 className="text-primary text-3xl font-extrabold text-center mb-6">Selamat Datang di Sekolah</h2>
