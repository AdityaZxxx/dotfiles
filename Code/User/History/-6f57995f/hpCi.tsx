		...
		<div className="p-4 font-sans">
			<div className="max-w-6xl mx-auto bg-white rounded-lg shadow-md">
				<div className="p-6 border-b">
					<h2 className="text-3xl font-extrabold text-primary">Hal yang sering ditanyakan</h2>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
					<div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200">
						<h3 className="text-lg font-semibold text-primary mb-2">How can I create an account?</h3>
					...
					<div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200">
						<h3 className="text-lg font-semibold text-primary mb-2">Is there a mobile app available?</h3>
					...
					<div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200">
						<h3 className="text-lg font-semibold text-primary mb-2">How can I reset my password?</h3>
