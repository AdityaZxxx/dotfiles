	...
	return (
		<div className="font-[sans-serif]">
			...
			<div className="max-w-5xl max-md:max-w-xl max-sm:max-w-sm mx-auto -mt-48 px-6">
				<h2 className="text-4xl max-md:text-3xl text-center font-extrabold text-white mb-12">Meet Our Professional Team</h2>
				...
				<div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:justify-center text-center">
					<div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
						<div className="lg:min-h-[250px]">
							<Image width={500} height={500} alt="" src="https://readymadeui.com/team-1.webp" className="w-full rounded-lg inline-block" />
						</div>
					...
					<div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
						<div className="lg:min-h-[250px]">
							<Image width={500} height={500} alt="" src="https://readymadeui.com/team-2.webp" className="w-full rounded-lg inline-block" />
						</div>
					...
					<div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
						<div className="lg:min-h-[250px]">
							<Image width={250} height={250} alt="team" src="https://readymadeui.com/team-3.webp" className="w-full rounded-lg inline-block" />
						</div>

						<div className="mt-6">
							<h4 className="text-gray-800 text-lg font-bold">Simon Konecki</h4>
							<p className="text-sm text-gray-600 mt-1">Web Designer</p>
