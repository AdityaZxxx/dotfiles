...
export const Teams = () => {
	return (
		<div className="font-[sans-serif] mt-12">
				...
				<div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:justify-center text-center">
					<div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
						<div className="lg:min-h-[250px]">
							<Image width={500} height={500} alt="" src="/teams.webp" className="w-full rounded-lg inline-block" />
						</div>
					...
					<div className="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
						<div className="lg:min-h-[250px]">
							<Image width={250} height={250} alt="team" src="/teams.webp" className="w-full rounded-lg inline-block" />
						</div>
