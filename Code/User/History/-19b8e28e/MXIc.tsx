...
const LoginForm = () => {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		...
		try {
			// Ensure we have a valid callbackUrl, defaulting to '/' if not available
			...
			const res = await signIn('credentials', {
				...
				callbackUrl: callbackUrl, // Pass the validated callbackUrl here
			});
			...
			if (res?.error) {
				...
				push(callbackUrl); // Proceed with the redirect to the callback URL
			}
		} catch (error) {
