				...
				<ul className="flex flex-wrap justify-center gap-6 mt-8">
					<li>
						<a href="javascript:void(0)">
							<Facebook className="w-8 h-8 text-white rounded-full flex items-center justify-center" />
						</a>
					</li>
					<li>
						<a href="javascript:void(0)">
							<Linkedin className="w-8 h-8 text-white rounded-full flex items-center justify-center" />
						</a>
					</li>
					<li>
						<a href="javascript:void(0)">
							<Instagram className="w-8 h-8 text-white rounded-full flex items-center justify-center" />
						</a>
					</li>
					<li>
						<a href="javascript:void(0)">
							<Youtube className="w-8 h-8 text-white rounded-full flex items-center justify-center" />
						</a>
					</li>
				</ul>
			</div>
			...
			<div className="flex max-md:flex-col gap-4">
				<ul className="flex flex-wrap gap-4">
					<li className="text-sm">
						<a href="javascript:void(0)" className="text-gray-600 font-semibold hover:underline">
							Terms of Service
						</a>
					</li>
					<li className="text-sm">
				...
				<p className="text-sm text-gray-600 md:ml-auto">© ReadymadeUI. All rights reserved.</p>
			</div>
		</footer>
	);
};
