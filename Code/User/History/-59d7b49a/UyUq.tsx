import { Facebook, Instagram, Linkedin, LucideTwitch, LucideTwitter, X } from 'lucide-react';
		...
		<footer className="bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide">
			<div className="max-w-[1240px] mx-auto text-center">
				...
				<ul className="flex flex-wrap justify-center gap-6 mt-8">
					...
					<li>
						<a href="javascript:void(0)">
							<LucideTwitter className="w-8 h-8 text-white bg-blue-600 rounded-full flex items-center justify-center" />
						</a>
					</li>
				</ul>
			</div>
