...
export const Footer = () => {
	return (
		<footer className="bg-gray-200 py-10 px-10 font-sans tracking-wide">
			<div className="max-w-[1240px] mx-auto text-center">
				<a href="javascript:void(0)" className="inline-block">
					<Image width={500} height={500} src="https://readymadeui.com/readymadeui-light.svg" alt="logo" className="w-44 text-gray-600" />
				</a>
