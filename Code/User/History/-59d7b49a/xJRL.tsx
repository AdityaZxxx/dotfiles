		...
		<footer className="bg-gray-200 py-10 px-10 font-sans tracking-wide">
			...
			<ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
				<li className="flex items-center">
					...
					<a href="javascript:void(0)" className="text-gray- text-sm ml-3">
			...
			<div className="flex max-md:flex-col gap-4">
				<ul className="flex flex-wrap gap-4">
					<li className="text-sm">
						<a href="javascript:void(0)" className="text-gray- font-semibold hover:underline">
							Terms of Service
						</a>
					</li>
					<li className="text-sm">
				...
				<p className="text-sm text-gray- md:ml-auto">© ReadymadeUI. All rights reserved.</p>
			</div>
		</footer>
	);
};
