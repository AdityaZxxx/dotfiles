...
export const Navbar = () => {
	...
	return (
		<nav className="sticky top-0 bg-secondary rounded-xl flex justify-between items-center h-24 sm:h-14 max-w-[1240px] mx-auto px-4 text-primary font-semibold">
			{/* Logo */}
