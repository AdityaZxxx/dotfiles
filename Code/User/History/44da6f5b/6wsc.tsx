...
export const Navbar = () => {
	...
	return (
		<nav className="sticky top-0 bg-white border-b-2 rounded-xl flex justify-between items-center sm:h-24 h-14 max-w-[1240px] mx-auto px-4 text-primary font-semibold">
			{/* Logo */}
