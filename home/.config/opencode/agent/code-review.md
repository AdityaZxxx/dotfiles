---
description: Tactical code reviewer for PRs and uncommitted changes. Reviews bugs, security, patterns. Fast and focused. For strategic/architectural advice, use @oracle instead.
mode: subagent
temperature: 0.1
permission:
  "*": deny
